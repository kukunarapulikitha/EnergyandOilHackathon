...
├── tabs/           # One folder per dashboard tab
├── hooks/          # Custom React hooks for data fetching
└── lib/            # API clients and calculation utilities
-->

## Cross-Tab Data Flow

<!-- How does data actually move between tabs in your final implementation?
List at least 2 concrete examples with specifics — not just "tab 1 feeds tab 2" but how (shared state, context, URL params, etc.) -->

## AI Integration Design

<!-- How did you integrate the AI feature?
- What context do you pass to the model?
- How do you handle the boundary between AI output and verified data?
